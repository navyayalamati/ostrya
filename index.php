...
@media only screen and (max-width: 400px) {
    ...
    body {
        background-color: lightblue;
		 ...
		 #div1 { position:absolute; width:0%; height:50px; margin:0 auto ; }
...
#div1 a:hover { font-weight:700; }
#div1 .blue {color:blue;}
#div1 .red {color:red;}
#div1 .yellow {color:yellow;}

p { font: 16px Microsoft YaHei; text-align: center; color: #FFF; }
p a { font-size: 28px; color: #FFF; }
p a:hover { color: red; }

#bg_container{ height:100%; width:100%; overflow:hidden; position:fixed }
#bg{ width:100%; }
#content{ z-index:999;  top:0px; padding-right:500px; padding-top:50px; color:#FFF; text-shadow:#000 2px 2px; }
</style>
</head>
<body>
